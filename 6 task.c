#include <stdio.h>// директива подключени€ файлов библиотеки(предпроцессор - обработка перед компли€цией)
#define YES 1 // макроподстановка
#define NO 0
#define MAXLINE 100
void process_line( char buffer[]);// объ€вление интерфейс функции([аргументы])  
